...
const sendBitcoin = async (recieverAddress , hash ,amountToSend) => {
    const sochain_network = process.env.network;
    ...
    const urlr = 'https://api.smartbit.com.au/v1/blockchain/pushtx'
...
module.exports = {sendBitcoin, isValidDigest}

// sendBitcoin(address2,0.0011)